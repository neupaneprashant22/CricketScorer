...
document.getElementById("match-of").innerHTML="Match: "+team1+" vs "+team2;
document.getElementById("toss").innerHTML+="Toss: "+toss+ " won the toss and decided to "+decide+" first.";
...
startsecond.addEventListener("click",function(e)
{
    ...
    window.location.href = "./secondinnings.html";
})
